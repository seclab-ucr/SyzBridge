...
class VM(VMInstance, VMState):
    def __init__(self, linux, kernel, port, image, hash_tag, key, vmlinux=None, tag='', arch='amd64', work_path='/tmp/', mem="8G", cpu="8", gdb_port=None, mon_port=None, timeout=None, debug=False, logger=None, log_name='vm.log', log_suffix="", snapshot=True):
