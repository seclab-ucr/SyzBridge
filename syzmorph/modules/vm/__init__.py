...
class VM(VMInstance, VMState):
    def __init__(self, linux, cfg, vmlinux, port, image, hash_tag, key, tag='', arch='amd64', work_path='/tmp/', mem="2G", cpu="2", gdb_port=None, mon_port=None, timeout=None, debug=False, logger=None, log_name='vm.log', log_suffix=""):
